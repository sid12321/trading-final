...
from training_progress import HyperparameterOptimizationProgress
...
class MCMCOptimizer:
    ...
    def run_optimization(self) -> Dict:
        ...
        progress = HyperparameterOptimizationProgress(self.max_iterations)
        progress.start()
        ...
        for iteration in range(1, self.max_iterations + 1):
            ...
            # Update progress bar
            progress.update(current_reward, current_params)
